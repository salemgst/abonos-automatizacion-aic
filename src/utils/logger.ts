 ...
 */
export function logParsedEmail(parsed: ParsedEmailData, emailFrom: string, index: number): void {
 ...
 */
export function logCompletionSummary(generatedFiles: string[], debugMode: boolean): void {
...
export function logBankCurrencySummary(
  ...
  table.addRows([
    ...
    { concepto: "Movimientos nuevos", cantidad: newMovements },
    { concepto: "Movimientos omitidos", cantidad: skipped },
  ]);
